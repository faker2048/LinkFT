...
namespace SteamLinkVRCFTModule
{
    public class SteamLinkVRCFTModule : ExtTrackingModule
    {
        ...
        private void UpdateEyeTracking()
        {
            ...
            {
                float fLeftOpenness = CalculateEyeOpenness(OSCHandler.eyelids[0],
                    OSCHandler.ueData[UnifiedExpressions.EyeSquintLeft]);
                float fRightOpenness = CalculateEyeOpenness(OSCHandler.eyelids[1],
        ...
        private void UpdateFaceTracking()
        {
            ...
            UnifiedTracking.Data.Shapes[(int)MouthUpperUpLeft].Weight = Math.Max(0,
                UnifiedTracking.Data.Shapes[(int)MouthUpperUpLeft].Weight -
                UnifiedTracking.Data.Shapes[(int)NoseSneerLeft].Weight);
            UnifiedTracking.Data.Shapes[(int)MouthUpperUpRight].Weight = Math.Max(0,
                UnifiedTracking.Data.Shapes[(int)MouthUpperUpRight].Weight -
                UnifiedTracking.Data.Shapes[(int)NoseSneerRight].Weight);
            UnifiedTracking.Data.Shapes[(int)MouthUpperDeepenLeft].Weight = Math.Max(0,
                UnifiedTracking.Data.Shapes[(int)MouthUpperUpLeft].Weight -
                UnifiedTracking.Data.Shapes[(int)NoseSneerLeft].Weight);
            UnifiedTracking.Data.Shapes[(int)MouthUpperDeepenRight].Weight = Math.Max(0,
                UnifiedTracking.Data.Shapes[(int)MouthUpperUpRight].Weight -
                UnifiedTracking.Data.Shapes[(int)NoseSneerRight].Weight);
